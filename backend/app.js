const express = require ('express');
  //In Node.js, const express = require('express') is a line of code that imports the Express.js framework into a Node.js application.
const app =express ();
...
app.use((req, res, next) => {
    res.header('Access-Control-Allow-Origin', 'http://localhost:4200'); // replace with your desired origin
